"""wadduply_24146 URL Configuration
...
admin.site.site_header = "WADDUPLY"
admin.site.site_title = "WADDUPLY Admin Portal"
admin.site.index_title = "WADDUPLY Admin"

# swagger
api_info = openapi.Info(
    title="WADDUPLY API",
    default_version="v1",
    description="API documentation for WADDUPLY App",
)
